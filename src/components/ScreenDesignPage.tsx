  ...
  return (
    <div className="h-screen bg-stone-100 dark:bg-stone-900 animate-fade-in flex flex-col overflow-hidden">
      ...
      <header className="border-b border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-950 shrink-0 z-50">
        <div className="px-4 py-2 flex items-center gap-4">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => navigate(`/${projectId}/design/sections/${sectionId}`)}
          ...
          <div className="ml-auto flex items-center gap-4">
            ...
            <ThemeToggle />
            <a
              href={`/${projectId}/design/sections/${sectionId}/screen-designs/${screenDesignName}/fullscreen`}
              target="_blank"
      ...
      >
        ...
        >
          <iframe
            src={`/${projectId}/design/sections/${sectionId}/screen-designs/${screenDesignName}/fullscreen`}
...
export function ScreenDesignFullscreen() {
  ...
  }, [projectId, sectionId]) // Depends on projectId + sectionId to check section-specific shell config
